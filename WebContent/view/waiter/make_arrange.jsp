				...
				<div class="g-postlist" id="post_content">
					<div class="m-post m-post-photo">
						<div class="content">
							<div class="wrap">
								<div class="img">
									<a href="#"><img src="../picture/make_arrange.jpg"></a>
								</div>
							</div>
						</div>
					</div>
					<iframe id="make_arrange_table_frame" style="width:550px;scrolling:no;display:none;" src="<%=request.getContextPath()+"/view/waiter/make_arrange_table.jsp"%>">
					</iframe>
				</div>
			</div>
		</div>
