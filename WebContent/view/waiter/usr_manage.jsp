...
<jsp:include flush="true" page="/view/waiter/head.jsp"></jsp:include>
			...
			<div class="g-main">
				<div class="g-postlist" id="post_content">
					...
					<iframe id="usr_table_frame" style="width:550px;scrolling:no;display:none;" src="<%=request.getContextPath()+"/view/waiter/existing_usr_table.jsp"%>">
					</iframe>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
      window.init_usr_table = function() {
          ...
          var sub_window = window.frames['usr_table_frame'];
