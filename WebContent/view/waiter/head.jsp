			...
			<div id="side-bar" class="g-side" style="visibility: visible; left: 293.5px;">
				...
				<div class="m-navandpage">
					<div class="nav">
						...
						<div class="itm">
							<a href="<%=request.getContextPath()+"/view/waiter/make_arrange.jsp"%>">制定活动安排</a>
						</div>
						<div class="itm">
							<a href="<%=request.getContextPath()+"/view/allParticipations"%>">记录参加人员</a>
						</div>
						<div class="itm">
							<a href="<%=request.getContextPath()+"/view/allUsers"%>">管理用户</a>
						</div>
						<div class="itm">
