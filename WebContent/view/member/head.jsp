		...
		<div class="g-body f-clear">
			...
			<div id="side-bar" class="g-side" style="visibility: visible; left: 293.5px;">
				...
				<div class="m-navandpage">
					<div class="nav">
						<div class="itm">
							<a href="<%=request.getContextPath()+"/view/allActivities"%>">首页</a>
						</div>
						<div class="itm">
							<a href="<%=request.getContextPath()+"/view/member/usr_info.jsp"%>">我的信息</a>
						</div>
						<div class="itm">
							<a href="<%=request.getContextPath()+"/view/reserveActRecord"%>">我预订的活动</a>
						</div>
						<div class="itm">
							<a href="<%=request.getContextPath()+"/view/queryPartRecord"%>">我参加的活动</a>
						</div>
						<div class="itm">
							<a href="<%=request.getContextPath()+"/view/queryPayRecord"%>">我的缴费记录</a>
						</div>
						<div class="itm">
							<a href="<%=request.getContextPath()+"/view/member/payment.jsp"%>">去支付</a>
						</div>
						<div class="itm">
